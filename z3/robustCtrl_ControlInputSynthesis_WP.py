...
for pattern in set(patternList):
    ...
    while (isSat == 1) and (todepth > 0):  
        ...
        print("Trying for robust controller in "+str(K)+" steps, from safex to "+str(todepth))
        forallvars="" #new
        antecedent=""
        consequent=""
        ...
        fileName = modelName + "_robustCtrl_1to"+ str(todepth)+"_1step.py"
        ...
        for i in range(K):
            ...
            for varcount1 in range(1,u_count+1):
                ...
                antecedent+="attackOnU"+str(varcount1)+"_"+str(i)+"==0,\n"
            ...
            for varcount1 in range(1,y_count+1):
                ...
                antecedent+="attackOnY"+str(varcount1)+"_"+str(i)+"==0,\n"
        ...
        execs+= "\nfsmt = open(\""+path+modelName+"_"+str(todepth)+".smt2\", \"w+\")\n"
        # fsmt = open(path+modelName+"_"+str(K)+".smt2", w+)
        ...
        if isSat==1:
            ...
            # if todepth != 0.995 :
                # todepth+= 0.05
            #     fileName = modelName + "_robustCtrl_1to"+ str(todepth)
            #     print("go to "+path+fileName+".z3out \n")       
