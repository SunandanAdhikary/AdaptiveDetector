...
%             obj. xatk(1)= obj.x_act(1);
        ...
        %% stateProg(object, iteration. detection window size,...
        %% new control input, attack value on y, attack vaue on u)
        function obj = stateProg(obj,i,th,dtc_windw,u_new,ay,au)
            obj.t(i+1)=i*obj.Ts;
            obj.a_u(:,i+1)=au;
            obj.a_y(:,i+1)=ay;
